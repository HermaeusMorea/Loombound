...
from src.core.models import ChoiceContext, NarrationBlock, RuleTemplate
...
def render_narration(
    ...
    if rule is None:
        ...
        return NarrationBlock(
            opening=opening.format(decision_type=context.decision_type),
    ...
    return NarrationBlock(
        opening=_pick(templates, opening_key).format(decision_type=context.decision_type),
